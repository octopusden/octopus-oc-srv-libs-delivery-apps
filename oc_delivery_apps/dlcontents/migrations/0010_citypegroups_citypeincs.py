...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dlcontents', '0009_auto_20171204_0100'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ci_type_group', models.ForeignKey(to='dlcontents.CiTypeGroups', to_field='code', on_delete=models.CASCADE, blank=False, null=False)),
            ],
        ),
    ]
