    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ForeignKey(to='dlcontents.Files', on_delete=models.CASCADE, blank=False, null=False)),
            ],
        ),
        migrations.CreateModel(
            name='LocTypes',
        ...
        migrations.AddField(
            ...
            name='cs_type',
            field=models.ForeignKey(to='dlcontents.CsTypes', to_field='code', on_delete=models.CASCADE, blank=False, null=False),
        ),
        migrations.AddField(
            model_name='checksums',
            name='file',
