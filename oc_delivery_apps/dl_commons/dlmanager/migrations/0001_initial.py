...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('clientid', models.ForeignKey(to='dlmanager.Client', db_column='clientId', on_delete=models.CASCADE)),
                ('userid', models.ForeignKey(to=settings.AUTH_USER_MODEL, db_column='userId', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Delivery',
            fields=[
                ...
                ('request_by', models.CharField(max_length=127, null=True, blank=True)),
                ('mf_delivery_revision', models.IntegerField(null=True, blank=True)),
                ('mf_delivery_author', models.CharField(max_length=127, null=True, blank=True)),
                ('mf_source_svn', models.CharField(max_length=511, null=True, blank=True)),
                ('mf_ci_build', models.IntegerField(null=True, blank=True)),
                ('mf_ci_job', models.CharField(max_length=63, null=True, blank=True)),
                ('mf_tag_svn', models.CharField(max_length=511, null=True, blank=True)),
                ('mf_delivery_comment', models.TextField(null=True, blank=True)),
                ('mf_delivery_files_specified', models.TextField(null=True, blank=True)),
                ('build_status', models.CharField(max_length=127, null=True, blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deliveryid', models.ForeignKey(to='dlmanager.Delivery', db_column='deliveryId', on_delete=models.CASCADE)),
            ],
            options={
