...
class Command(base.BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        shifted=Delivery.objects.filter(creation_date__isnull=False, request_date__isnull=False, creation_date__gt=F("request_date"))
        
        date_from=shifted.aggregate(Min("creation_date"))["creation_date__min"]
